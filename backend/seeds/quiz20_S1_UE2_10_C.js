module.exports = [
  {
    ...
    chapter: "Stérilisation — méthodes, contrôles et traçabilité",
    difficulty: "medium",
    duration: 15,
    isPublished: true,
    questions: [
  ...
  },
  {
    ...
    semester: "Semestre 1",
    category: "UE 2.10 - Infectiologie et hygiène",
    chapter: "Désinfection et décontamination — niveaux, produits et matériels",
    difficulty: "medium",
    duration: 15,
    isPublished: true,
    questions: [
  ...
  },
  {
    ...
    semester: "Semestre 1",
    category: "UE 2.10 - Infectiologie et hygiène",
    chapter: "Gestion des DASRI — tri, conditionnement et filière d'élimination",
    difficulty: "medium",
    duration: 15,
    isPublished: true,
    questions: [
  ...
  },
  {
    ...
    semester: "Semestre 1",
    category: "UE 2.10 - Infectiologie et hygiène",
    chapter: "Antibiothérapie 1 — classes d'antibiotiques, spectre et mécanismes d'action",
    difficulty: "medium",
    duration: 15,
    isPublished: true,
    questions: [
  ...
  },
  {
    ...
    semester: "Semestre 1",
    category: "UE 2.10 - Infectiologie et hygiène",
    chapter: "Antibiothérapie 2 — règles de prescription, durée et suivi biologique",
    difficulty: "medium",
    duration: 15,
    isPublished: true,
    questions: [

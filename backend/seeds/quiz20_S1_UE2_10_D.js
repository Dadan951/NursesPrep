module.exports = [
  {
    ...
    chapter: "Résistances bactériennes — mécanismes, BMR/BHR et mesures de contrôle",
    difficulty: "medium",
    duration: 16,
    isPublished: true,
    questions: [
  ...
  },
  {
    ...
    semester: "Semestre 1",
    category: "UE 2.10 - Infectiologie et hygiène",
    chapter: "Infections digestives — gastro-entérites bactériennes et virales, Clostridium",
    difficulty: "medium",
    duration: 16,
    isPublished: true,
    questions: [
  ...
  },
  {
    ...
    semester: "Semestre 1",
    category: "UE 2.10 - Infectiologie et hygiène",
    chapter: "Infections respiratoires — pneumonies, tuberculose et grippe",
    difficulty: "medium",
    duration: 16,
    isPublished: true,
    questions: [
  ...
  },
  {
    ...
    semester: "Semestre 1",
    category: "UE 2.10 - Infectiologie et hygiène",
    chapter: "Infections urinaires — agents pathogènes, diagnostic et traitement",
    difficulty: "medium",
    duration: 16,
    isPublished: true,
    questions: [
  ...
  },
  {
    ...
    semester: "Semestre 1",
    category: "UE 2.10 - Infectiologie et hygiène",
    chapter: "Surveillance épidémiologique — réseaux, signalement et alertes sanitaires",
    difficulty: "medium",
    duration: 16,
    isPublished: true,
    questions: [

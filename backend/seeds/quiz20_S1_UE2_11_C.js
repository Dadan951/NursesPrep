module.exports = [
  {
    ...
    chapter: "Antalgiques palier 1 — paracétamol, AINS et aspirine",
    difficulty: "medium",
    duration: 15,
    isPublished: true,
    questions: [
  ...
  },
  {
    ...
    semester: "Semestre 1",
    category: "UE 2.11 - Pharmacologie et thérapeutiques",
    chapter: "Antalgiques paliers 2 et 3 — tramadol, codéine, morphine et surveillance",
    difficulty: "medium",
    duration: 15,
    isPublished: true,
    questions: [
  ...
  },
  {
    ...
    semester: "Semestre 1",
    category: "UE 2.11 - Pharmacologie et thérapeutiques",
    chapter: "Antibiotiques en pratique — pénicillines, céphalosporines, fluoroquinolones",
    difficulty: "medium",
    duration: 15,
    isPublished: true,
    questions: [
  ...
  },
  {
    ...
    semester: "Semestre 1",
    category: "UE 2.11 - Pharmacologie et thérapeutiques",
    chapter: "Anticoagulants — héparine, HBPM, AVK et AOD : mécanismes et surveillance",
    difficulty: "hard",
    duration: 15,
    isPublished: true,
    questions: [
  ...
  },
  {
    ...
    semester: "Semestre 1",
    category: "UE 2.11 - Pharmacologie et thérapeutiques",
    chapter: "Insulines et antidiabétiques — types d'insuline, schémas et surveillance glycémique",
    difficulty: "medium",
    duration: 15,
    isPublished: true,
    questions: [

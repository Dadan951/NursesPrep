module.exports = [
  {
    ...
    chapter: "Télémédecine — téléconsultation, téléexpertise et cadre réglementaire",
    difficulty: "medium",
    duration: 15,
    isPublished: true,
    questions: [
  ...
  },
  {
    ...
    semester: "Semestre 1",
    category: "UE 6.1 - Méthodes de travail et TIC",
    chapter: "Réseaux sociaux et e-réputation — risques professionnels et bonnes pratiques",
    difficulty: "medium",
    duration: 15,
    isPublished: true,
    questions: [
  ...
  },
  {
    ...
    semester: "Semestre 1",
    category: "UE 6.1 - Méthodes de travail et TIC",
    chapter: "Prescription électronique — traçabilité, alertes et sécurisation",
    difficulty: "medium",
    duration: 15,
    isPublished: true,
    questions: [
  ...
  },
  {
    ...
    semester: "Semestre 1",
    category: "UE 6.1 - Méthodes de travail et TIC",
    chapter: "Intelligence artificielle en santé — applications, limites et enjeux éthiques",
    difficulty: "hard",
    duration: 15,
    isPublished: true,
    questions: [
  ...
  },
  {
    ...
    semester: "Semestre 1",
    category: "UE 6.1 - Méthodes de travail et TIC",
    chapter: "Communication interprofessionnelle — outils collaboratifs et réunions de synthèse",
    difficulty: "medium",
    duration: 15,
    isPublished: true,
    questions: [
